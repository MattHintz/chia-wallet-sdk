...
def eip712_type_hash() -> bytes: ...
def eip712_domain_separator(genesisChallenge: bytes) -> bytes: ...
def eip712_hash_to_sign(genesisChallenge: bytes, coinId: bytes, delegatedPuzzleHash: bytes) -> bytes: ...
def eip712_member_inner_puzzle_hash(genesisChallenge: bytes, publicKey: K1PublicKey) -> bytes: ...
...
def eip712_member_hash(config: MemberConfig, genesisChallenge: bytes, publicKey: K1PublicKey) -> bytes: ...
...
class Puzzle:
    ...
    def parse_bulletin(self, coin: Coin, solution: Program) -> Optional[ParsedBulletin]: ...
...
class ParsedCat:
    ...
    def __init__(self, cat: Cat, p2Puzzle: Puzzle, p2Solution: Program, revoked: bool) -> None: ...
    cat: Cat
    p2_puzzle: Puzzle
    p2_solution: Program
    revoked: bool
...
class ParsedBulletin:
    def clone(self) -> ParsedBulletin: ...
    def __init__(self, bulletin: Bulletin, p2Puzzle: Puzzle, p2Solution: Program) -> None: ...
    bulletin: Bulletin
    p2_puzzle: Puzzle
    p2_solution: Program
class P2ParentCoin:
